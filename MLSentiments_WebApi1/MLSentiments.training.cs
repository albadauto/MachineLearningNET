...
namespace MLSentiments_WebApi1
{
    public partial class MLSentiments
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"text",outputColumnName:@"text")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator: mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=0.03649385F,L2Regularization=2.128595F,LabelColumnName=@"sentiment",FeatureColumnName=@"Features"}), labelColumnName:@"sentiment"))      
